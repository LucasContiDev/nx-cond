...
@Component({
  selector: 'ngx-agendamentos-cadastrar',
  styleUrls: ['./agendamentos-cadastrar.component.scss'],
  templateUrl: './agendamentos-cadastrar.component.html',
})
export class AgendamentosCadastrarComponent {
  confirmado = false;
